...
const sectionData = {
    analisis: {
        ...
        items: [
            ...
            { text: 'Justificación del Proyecto', link: '#justificacion' },
            { text: 'Definición del Problema', link: '#problema' },
            { text: 'Antecedentes y Estado del Arte', link: '#antecedentes' },
            { text: 'Objetivo General y Específicos', link: '#objetivos' },
            { text: 'Alcance del Sistema', link: '#alcance' },
            { 
              text: 'Requisitos', 
              link: '#requisitos',
              children: [
                  ...
                  { text: 'Requisitos No Funcionales (RNF)', link: '#req-nofuncionales' },
                  { text: 'Historias de Usuario', link: '#historias' },
                  { text: 'Reglas del Negocio', link: '#reglas' }
              ]
            }
        ]
    },
